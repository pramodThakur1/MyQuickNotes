...
public class NoteImagesAdapter extends RecyclerView.Adapter<NoteImagesAdapter.ImageViewHolder> {
	...
	public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
		...
		// FIX: DiskCacheStrategy.NONE — images already local files hain, disk cache zaroorat nahi.
		// Pehle DiskCacheStrategy.ALL tha jisse har photo TWICE cache mein save hoti thi
		// (original + 1080px resized) = ~15-18MB extra cache bloat sirf 3-4 photos se.
